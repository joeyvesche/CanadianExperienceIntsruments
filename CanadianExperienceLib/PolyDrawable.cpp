 ...
 */
void PolyDrawable::SetDialog(wxFrame* mainframe)
{

}

void PolyDrawable::SetMachineNum(int num)
{

}

void PolyDrawable::SetStartTime(double time)
{

}

void PolyDrawable::SetEndTime(double time)
{
