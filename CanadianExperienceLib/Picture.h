...
private:
    ...
    /// The first machine
    std::shared_ptr<DrawableMachine> mMachine1;
    /// The second Machine
    std::shared_ptr<DrawableMachine> mMachine2;
...
public:
    ...
    */
     ...
     * @return shared pointer to the first machine
     */
    std::shared_ptr<DrawableMachine> GetMachine1() { return mMachine1; }

    /**
     * Get the first machine
     * @return shared pointer to the first machine
     */
    std::shared_ptr<DrawableMachine> GetMachine2() { return mMachine2; }
     ...
     */
    void SetMachine1(std::shared_ptr<DrawableMachine> machine) { mMachine1 = machine; }

    /**
     * Set machine 2 pointer
     * @param machine Set the machine1
     */
    void SetMachine2(std::shared_ptr<DrawableMachine> machine) { mMachine2 = machine; }
};
