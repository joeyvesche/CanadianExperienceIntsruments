 ...
 */void ImageDrawable::SetDialog(wxFrame* mainframe)
{

}

void ImageDrawable::SetMachineNum(int num)
{

}

void ImageDrawable::SetStartTime(double time)
{

}

void ImageDrawable::SetEndTime(double time)
{
