...
{
    mMachine1->SetKeyFrame(mTimeline.GetCurrentFrame());
    mMachine2->SetKeyFrame(mTimeline.GetCurrentFrame());
    for (auto actor : mActors)
    {
        actor->Draw(graphics);
    }
...
void Picture::Save(const wxString& filename)
{
    ...
    root->AddAttribute(L"Machine1 number", wxString::Format(wxT("%i"),(mMachine1->GetMachineNum())));
    root->AddAttribute(L"Machine1 Start time", wxString::Format(wxT("%i"),(mMachine1->GetStartTime())));
    root->AddAttribute(L"Machine1 End time", wxString::Format(wxT("%i"),(mMachine1->GetEndTime())));

    root->AddAttribute(L"Machine2 number", wxString::Format(wxT("%i"),(mMachine2->GetMachineNum())));
    root->AddAttribute(L"Machine2 Start time", wxString::Format(wxT("%i"),(mMachine2->GetStartTime())));
    root->AddAttribute(L"Machine2 End time", wxString::Format(wxT("%i"),(mMachine2->GetEndTime())));
...
//    root->GetAttribute(L"Machine1 Number", wxString::Format(wxT("%i"),mMachine1->GetMachineNum()));
//    root->GetAttribute(L"Machine Start time", wxString::Format(wxT("%i"),mMachine1->GetStartTime()));
//    root->GetAttribute(L"Machine End time", wxString::Format(wxT("%i"),mMachine1->GetEndTime()));

//    root->GetAttribute(L"Machine number", wxString::Format(wxT("%i"),mMachine2->GetMachineNum()));
//    root->GetAttribute(L"Machine Start time", wxString::Format(wxT("%i"),mMachine2->GetStartTime()));
//    root->GetAttribute(L"Machine End time", wxString::Format(wxT("%i"),mMachine2->GetEndTime()));
